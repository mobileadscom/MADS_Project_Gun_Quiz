...
var renderAd = function () {
    ...
    var qa = [
        {
            'Q': 'Where was the first gunpowder firearm developed?',
            'A': ['China', 'Persia', 'Italy'],
            'T': '1stgunpowder_q1',
            'C': 'China'
        }, {
            'Q': 'Which firearm was known as the Peacemaker?',
            'A': ['Colt M1873', 'Smith & Wesson Model 10', 'Springfield Model 1855 rifle-musket'],
            'T': 'peacemaker_q1',
            'C': 'Colt M1873'
        }, {
            'Q': 'What does the "AR" stand for in the popular AR-15 civilian rifle?',
            'A': ['Advanced recoil', 'ArmaLite rifle', 'Assault rifle'],
            'T': 'ar15civilianrifle_q1',
            'C': 'ArmaLite rifle'
        }, {
            'Q': 'What do you call the spiral grooves cut into the bore of the gun?',
            'A': ['Breech', 'Buttstock', 'Rifling'],
            'T': 'spiralgrooves_q1',
            'C': 'Rifling'
        }, {
            'Q': 'Which of these innovations did Samuel Colt bring to the world of firearms production?',
            'A': ['He invented the revolver.', 'He used an assembly line rather than individual gunsmiths.', 'He invented the safety catch.'],
            'T': 'samuelcolt_q1',
            'C': 'He invented the revolver.',
            'End': true
        }
    ]
    ...
    app.contentTag.innerHTML = '<div id="main" class="abs"><div id="ad-content" class="abs"><div id="front">' + content + '<br /><br /><div id="participate">PARTICIPATE NOW</div></div></div><div id="disclaimer" class="abs">Pol. ad. Texans for Greg Abbott</div></div>';
            ...
            answer.onclick = function (e) {
                ...
                if (current !== 'end') {
                    ...
                    switch (score) {
                        case 0:
                        case 1:
                            app.tracker('E', 'novice_1qncorrect_q1');
                            break;
                        case 2:
                            app.tracker('E', 'rifleman_2qncorrect_q1');
                            break;
                        case 3:
                            app.tracker('E', 'marksman_3qncorrect_q1');
                            break;
                        case 4:
                            app.tracker('E', 'sharpshooter_4qncorrect_q1');
                            break;
                        case 5:
                            app.tracker('E', 'expert_5qncorrect_q1');
                            break;
                    }
    ...
    signed.querySelector('#mail-submit').addEventListener('submit', function (e) {
        ...
        app.tracker('E', 'signedbkcontest_emailsubmit_q1', 'signedbkcontest_emailsubmit_q1', this.elements['email'].value);
        app.tracker('E', 'thankyou_q1');
    }, false);

    vote.addEventListener('click', function () {
        app.tracker('E', 'registertovote_clickhere_q1');
